...
import viettel from "../../assets/imgs/viettel.jpg";
import bidv from "../../assets/imgs/bidv.jpg";
import vingroup from "../../assets/imgs/logo-vingroup1.jpg";
import momo from "../../assets/imgs/momo.png";
import bgCreators from "../../assets/imgs/lightTech.32807735.jpg";
import creator1 from "../../assets/imgs/home_carousel_01.jpg";
import creator2 from "../../assets/imgs/home_carousel_02.jpg";
import creator3 from "../../assets/imgs/home_carousel_03.jpg";
import creator4 from "../../assets/imgs/home_carousel_04.jpg";
import creator5 from "../../assets/imgs/home_carousel_05.jpg";
import creator6 from "../../assets/imgs/home_carousel_06.jpg";
import creator7 from "../../assets/imgs/home_carousel_07.jpg";
import creator8 from "../../assets/imgs/home_carousel_08.jpg";
      ...
      <div className="px-4 py-24 mx-auto max-w-screen-2x">
        ...
        <div className="grid gap-10 lg:grid-cols-4 md:grid-cols-2">
          <div>
            ...
            />
            <h2 className="mt-5 text-xl font-medium text-center uppercase">
              VIETTEL
            </h2>
          </div>
