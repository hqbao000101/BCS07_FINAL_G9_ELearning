...
import tailwindcss from "../../assets/imgs/tailwindcss.jpg";
import html from "../../assets/imgs/html-structure.jpg";
import materialUI from "../../assets/imgs/materialUI.jpg";
import extensions from "../../assets/imgs/extensions.png";
import asyncAwait from "../../assets/imgs/async-await.png";
import typescript from "../../assets/imgs/typescript.jpg";
import antd from "../../assets/imgs/antd.png";
import logoUser1 from "../../assets/imgs/home_carousel_01.jpg";
import logoUser2 from "../../assets/imgs/home_carousel_02.jpg";
import logoUser3 from "../../assets/imgs/home_carousel_03.jpg";
  ...
  return (
    <div id="blog" className="container py-20 mx-auto">
      <Row>
        ...
        <Col
          className="relative hidden px-10 mt-10 lg:px-2 lg:mt-12 lg:block"
          xs={24}
          lg={7}
        >
