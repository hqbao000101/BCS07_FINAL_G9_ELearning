...
import teacherSample from "../../assets/imgs/home_carousel_01.jpg";
    ...
    if (user) {
      ...
      courseService
        ...
        .then(() => {
          api.open({
            message: (
              <h1 className="text-lg font-semibold">Đăng Ký Khóa Học</h1>
            ),
            description:
        ...
        .catch((err) => {
          api.open({
            ...
            className: `border-l-8 ${
              err.response.data ? "border-blue-500" : "border-red-500"
            }`,
          });
        });
    } else {
      api.open({
        ...
        description:
          "Bạn cần phải đăng nhập tài khoản trước khi đăng ký các khóa học!",
        icon: (
          <InfoCircleOutlined
            style={{
              color: "#0984e3",
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 sm:gap-5 sm:flex-row">
              <div className="sm:w-1/2">
                <p>
                  <i className="text-yellow-500 fa-solid fa-check"></i> Xây dựng
                  các ứng dụng web mạnh mẽ, nhanh chóng, thân thiện với người
                  dùng và phản ứng nhanh
                </p>
                <p className="my-3">
                  <i className="text-yellow-500 fa-solid fa-check"></i> Đăng ký
                  công việc được trả lương cao hoặc làm freelancer trong một
                  trong những lĩnh vực được yêu cầu nhiều nhất mà bạn có thể tìm
                  thấy trong web dev ngay bây giờ
                </p>
                <p className="my-3">
                  <i className="text-yellow-500 fa-solid fa-check"></i> Cung cấp
                  trải nghiệm người dùng tuyệt vời bằng cách tận dụng sức mạnh
                  của JavaScript một cách dễ dàng
                </p>
                <p>
                  <i className="text-yellow-500 fa-solid fa-check"></i> Tìm hiểu
                  tất cả về React Hooks và React Components
                </p>
              </div>
              <div className="sm:w-1/2">
                <p>
                  <i className="text-yellow-500 fa-solid fa-check"></i> Thông
                  thạo chuỗi công cụ hỗ trợ React, bao gồm cú pháp Javascript
                  NPM, Webpack, Babel và ES6 / ES2015
                </p>
                <p className="my-3">
                  <i className="text-yellow-500 fa-solid fa-check"></i> Nhận ra
                  sức mạnh của việc xây dựng các thành phần có thể kết hợp
                </p>
                <p className="my-3">
                  <i className="text-yellow-500 fa-solid fa-check"></i> Hãy là
                  kỹ sư giải thích cách hoạt động của Redux cho mọi người, bởi
                  vì bạn biết rất rõ các nguyên tắc cơ bản
                </p>
                <p>
                  <i className="text-yellow-500 fa-solid fa-check"></i> Nắm vững
                  các khái niệm cơ bản đằng sau việc cấu trúc các ứng dụng Redux
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mb-10">
              ...
              <div className="flex items-center justify-between py-3 px-2 border-b-[1px] border-orange-400/50 duration-300 hover:shadow-lg">
                <div className="flex items-center">
                  <i className="fa-solid fa-circle-play text-main me-2"></i>
                  <p className="line-clamp-1">Ghi chú nhanh về dấu ngoặc kép cho string interpolation</p>
                </div>
                <div className="flex items-center justify-end flex-grow">
                  <i className="fa-solid fa-clock text-main me-2"></i>
                  <p>15:00</p>
            ...
            <div className="mb-10">
              ...
              <div className="flex items-center justify-between py-3 px-2 border-b-[1px] border-orange-400/50 duration-300 hover:shadow-lg">
                <div className="flex items-center">
                  <i className="fa-solid fa-circle-play text-main me-2"></i>
                  <p className="line-clamp-1">React 17: Cập nhật các gói + Phiên bản React mới nhất</p>
                </div>
                <div className="flex items-center justify-end flex-grow">
                  <i className="fa-solid fa-clock text-main me-2"></i>
                  <p>15:00</p>
        ...
        <div className="mx-auto my-5 lg:my-10 sm:w-2/3 lg:w-1/3 lg:ps-10">
          <div className="sticky p-5 overflow-hidden rounded-md shadow-2xl top-28">
            ...
            <p className="my-5 text-2xl font-medium text-right">
              <i className="text-lg text-orange-400 fa-solid fa-bolt-lightning"></i>{" "}
              120.000<sup>đ</sup>
            </p>
            <button
            ...
            <div className="flex items-center justify-between py-5 border-b-[1px] border-gray-200">
              <p className="text-gray-500">
                Ghi danh:{" "}
                <span className="font-medium text-black">22 học viên</span>
              </p>
            ...
            <div className="flex items-center justify-between py-5 border-b-[1px] border-gray-200">
              <p className="text-gray-500">
                Thời gian:{" "}
                <span className="font-medium text-black">18 giờ</span>
              </p>
            ...
            <div className="flex items-center justify-between py-5 border-b-[1px] border-gray-200">
              <p className="text-gray-500">
                Trình độ:{" "}
                <span className="font-medium text-black">trung bình</span>
              </p>
